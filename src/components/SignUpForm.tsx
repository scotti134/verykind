        ...
        <div className="w-full max-w-sm">
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center mb-3">
              <span className="text-2xl font-bold text-gray-900">Very Kind</span>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
            <button
              ...
              className="w-full bg-gray-900 text-white py-2 text-sm rounded-md font-semibold hover:bg-gray-800 transition-all"
            >
              Go to Log In
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-12">
      ...
      <div className="max-w-lg mx-auto pt-12">
        <div className="mb-8">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Create an Account</h1>
          <p className="text-gray-700 text-base">
            Choose an option below to create a free account. Used Very Kind before?{' '}
            <button
              onClick={onSwitchToLogin}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div>
              <label htmlFor="retypeEmail" className="block text-sm font-semibold text-gray-900 mb-1.5">
                Retype Email
              </label>
              <input
                id="retypeEmail"
            ...
            <div className="space-y-3 pt-2">
              <label className="flex items-start">
                ...
                <span className="ml-2 text-sm text-gray-700">
                  Send me Very Kind news & updates.
                </span>
              </label>
              <label className="flex items-start">
                <input
